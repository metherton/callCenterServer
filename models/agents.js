	...
	client.workspace.workers.get(function (error, data) {
		...
		for (var i = 0; i < data.workers.length; i++) {
			...
			if (worker.friendlyName === friendlyName) {
				...
				phoneCapability.allowClientOutgoing('AP9b1001a76c80b78f4fb71baaa8fa0653');
				...
				console.log('requset setsso worker', req.session.worker);
...
module.exports.getSession = function (req, res, next) {
	...
	console.log('get reuest session work', req.session);
